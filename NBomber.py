...
# Author: N473K Inc.
# GitHub: https://github.com/SNayek404
# Version: 4.1.0
#########################################
...
def update():
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && rm -rf SABBIRNAYEK && git clone https://github.com/SABBIR-N473K/Nayek> /dev/null 2>&1")
        
        print("\033[37mDone")
        psb("\n    \033[92m[\033[37m*\033[92m] \033[37mStarting Tool...")
        time.sleep(0.8)
        
        os.system("cd .. && cd SABBIRNAYEK && python Nayekbomb.py")
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : Sabbir Nayek Inc.                \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/SNayek404 \033[94m│".center(columns+9))
